...
# ==============================================================================
# PROJECT CHIMERA V6 - THE FROZEN RESERVOIR
# ==============================================================================

CONFIG = {
    'batch_size': 64,
    'latent_dim': 512,
    'reservoir_layers': 1,        # Single deep tank
    'spectral_radius': 1.5,
    'input_scale': 1.0,           # Stronger input
    'dt': 0.1,                    
    'integration_steps': 15,      # More settling time
    
    'lr_readout': 0.005,
    'lr_reservoir': 0.0,          # ABSOLUTELY FROZEN (0.0)
...
# ==============================================================================
# FRC 840.003 - CHIMERA RESERVOIR NETWORK (FROZEN)
# ==============================================================================
...
# ==============================================================================
# TRAINING LOOP - MASKED READOUT + FROZEN RESERVOIR
# ==============================================================================
...
def train_chimera_v6(tasks):
    print("\nInitializing Project Chimera V6 (The Frozen Reservoir)...")
    model = ChimeraNet().to(device)
    
    # Optimizer only for Readout
    ...
    for task_id, task in enumerate(tasks):
        ...
        print(f"\n>>> Task {task_id} (V6 Mode - Active: {active_digits}) <<<")
...
if __name__ == "__main__":
    ...
    acc_matrix = train_chimera_v6(tasks)
    ...
    print("\n" + "="*60)
    print("PROJECT CHIMERA V6: FINAL REPORT")
    print("="*60)
    ...
    plt.title(f'Chimera V6 (Frozen) Memory Matrix (Forg={avg_forg*100:.1f}%)')
    plt.xlabel('Task')
    ...
    plt.savefig('chimera_v6_results.png')
    print("Saved matrix to chimera_v6_results.png")
