...
# ==============================================================================
# PROJECT CHIMERA V8 - RESERVOIR + EPISODIC REPLAY
# ==============================================================================
...
CONFIG = {
    ...
    'replay_batch_size': 16,      # Mix in replay samples
...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        # Sample mixed batch from all stored tasks
        all_samples = []
...
def get_split_mnist():
    ...
    for task_id in range(CONFIG['n_tasks']):
        ...
        # Create subsets - Important: store dataset for replay
        ...
        print(f"  Task {task_id}: Digits {digits}")
...
def train_chimera_v8(tasks):
    print("\nInitializing Project Chimera V8 (Replay)...")
...
if __name__ == "__main__":
    ...
    acc_matrix = train_chimera_v8(tasks)
    ...
    print("\n" + "="*60)
    print("PROJECT CHIMERA V8: FINAL REPORT")
    print("="*60)
    ...
    plt.title(f'Chimera V8 (Replay) Matrix (Forg={avg_forg*100:.1f}%)')
    plt.xlabel('Task')
    ...
    plt.savefig('chimera_v8_results.png')
    print("Saved matrix to chimera_v8_results.png")
